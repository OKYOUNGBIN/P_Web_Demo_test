...
//let leg_type4 = loadModel("/chair/leg/tablechair_0102_leg_2.glb").then(result => { leg4 = result.scene; });
...
//let seat_type5 = loadModel("/chair/seat/tablechair_0203_seat_2.glb").then(result => { seat5 = result.scene; });
